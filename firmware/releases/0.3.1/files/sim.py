...
MODULES={
 ...
 'ice_well':{'label':'ice well','desc':'Tap a shaded lens and let the hab stop drinking from emergency bags.','act':1,'max':4,'cost':{'regolith':120,'power':40},'rates':{'water':0.003},'caps':{'water':60},'beat':'beat_first_ice_well'},
 'greenhouse':{'label':'greenhouse','desc':'Trays, lamps, and patient hands. Food and oxygen become renewable.','act':1,'max':5,'cost':{'water':60,'power':70,'regolith':140},'rates':{'food':0.003,'o2':0.007},'caps':{'food':80,'population':4},'beat':'beat_first_greenhouse'},
