...
Development authority: read `BUILD_PROMPT.md` before game work. It is the original build/design prompt for this incremental Pico game and defines the constraints, architecture, and deliverables.
