...
def migrate(s):
    ...
    s.setdefault('save_version',1); s.setdefault('resources',{}); s.setdefault('caps',{}); s.setdefault('modules',{}); s.setdefault('cooldowns',{}); s.setdefault('unlocked_actions',['vent_co2']); s.setdefault('unlocked_tabs',['hab']); s.setdefault('archive',[]); s.setdefault('letters',[]); s.setdefault('ending',[]); s.setdefault('events',[]); s.setdefault('event_recent',[]); s.setdefault('away_recent',[]); s.setdefault('counters',{}); s.setdefault('tends',{}); s.setdefault('redeemed',[]); s.setdefault('trade_seq',0); s.setdefault('last_seen_wall_ms',0); s.setdefault('act',1); s.setdefault('legacy',0); s.setdefault('complete',False); s.setdefault('rng',12345)
